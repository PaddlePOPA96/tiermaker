...
type MFARelationshipSchema = Pick<RelationshipSchema, 'id' | 'type'> & Partial<Pick<RelationshipSchema, 'related' | 'attributes'>> & {
    relationships?: Relationship[];
};
/**
 * Represents a relationship from one MangaDex object to another such as a manga, author, etc via its id.
 */
declare class Relationship<T extends IDObject = IDObject> extends IDObject {
    /**
     ...
     */
    static resolveAll<T extends IDObject>(relationshipArray: Relationship<T>[]): Promise<T[]>;
    /**
     ...
     * @internal
     */
    static convertType<T2 extends IDObject>(type: string, arr: RelationshipSchema[], parent?: Relationship<IDObject>): Relationship<T2>[];
    /**
     * Create a reference to an object's self
     * @internal
     */
    static createSelfRelationship<T extends IDObject>(type: string, self: T): Relationship<T>;
    /**
